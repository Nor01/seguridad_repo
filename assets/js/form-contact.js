var stateObject = {
    Honduras: {
        ...
        "Bay Islands Departmento": ["Coxen Hole", "French Harbor", "Guanaja", "José Santos Guardiola", "Roatán", "Sandy Bay", "Savannah Bight", "Utila"],
        "Choluteca Departmento": [
            "Apacilagua",
            "Choluteca",
            "Ciudad Choluteca",
            "Concepción de María",
        ...
        "Gracias a Dios Departmento": ["Ahuas", "Auas", "Auka", "Barra Patuca", "Brus Laguna", "Iralaya", "Juan Francisco Bulnes", "Paptalaya", "Puerto Lempira", "Villeda Morales", "Wampusirpi", "Wawina"],
        "Intibucá Departmento": [
            "Camasca",
            "Colomoncagua",
            "Concepción",
            "Dolores",
        ...
        "Valle Departmento": ["Agua Fría", "Alianza", "Amapala", "Aramecina", "Caridad", "El Cubolero", "El Tular", "Goascorán", "Jícaro Galán", "La Alianza", "La Criba", "Langue", "Nacaome", "San Francisco de Coray", "San Lorenzo"],
        "Yoro Departmento": [
            "Agua Blanca Sur",
            "Arenal",
            "Armenia",
    ...
    "El Salvador": {
        ...
        Cabañas: ["Cinquera", "Dolores (Villa Doleres)", "Guacotecti", "Ilobasco", "Jutiapa", "San Isidro", "Sensuntepeque", "Tejutepeque", "Victoria"],
        Chalatenango: [
            "Agua Caliente",
            "Arcatao",
            "Azacualpa",
    ...
    "Estados Unidos": {
        ...
        "District of Columbia": ["Adams Morgan", "Bloomingdale", "Chevy Chase", "Shaw", "Washington, D.C."],
        Florida: [
            "Aberdeen",
            "Alachua",
            "Alachua County",
...
window.onload = function () {
    var a = document.getElementById("selectCountryList"),
        e = document.getElementById("selectStateList"),
        o = document.getElementById("selectCityList");
    for (var n in stateObject) a.options[a.options.length] = new Option(n, n);
    (a.onchange = function () {
        if (((e.length = 1), (o.length = 1), !(this.selectedIndex < 1))) for (var a in stateObject[this.value]) e.options[e.options.length] = new Option(a, a);
    }),
        a.onchange(),
        (e.onchange = function () {
            if (((o.length = 1), !(this.selectedIndex < 1))) for (var e = stateObject[a.value][this.value], n = 0; n < e.length; n++) o.options[o.options.length] = new Option(e[n], e[n]);
        });
};
